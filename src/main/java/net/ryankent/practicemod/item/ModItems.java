...
import net.ryankent.practicemod.item.custom.DowsingRodItem;
import net.minecraft.item.SwordItem;
import net.minecraft.item.ShovelItem;
import net.ryankent.practicemod.item.custom.ModAxeItem;
import net.ryankent.practicemod.item.custom.ModPickaxeItem;
import net.ryankent.practicemod.item.custom.ModHoeItem;
...
public class ModItems {
    ...
    public static final Item Test_Rod = registerItem("test_rod", new DowsingRodItem(new FabricItemSettings().group(ModItemGroup.MOD).maxDamage(10)));
